...
const filepath =
  process.env.ENV === "dev" ? "./emojis-dev.json" : "./emojis.json";
...
const transform = (emojiMap: Record<string, string>, animated?: boolean) => {
  for (const [name, id] of Object.entries(emojiMap)) {
    function toString() {
